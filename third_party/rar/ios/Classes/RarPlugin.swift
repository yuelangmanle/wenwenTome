...
public class RarPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "createRarArchive":
      // RAR creation on iOS is not well-supported in pure Swift/Objective-C
      result(["success": false, "message": "RAR creation is not supported on iOS. Consider using ZIP format instead."])
